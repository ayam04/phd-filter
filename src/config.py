...
RECENCY_YEARS = 8
CANDIDATES_PER_AREA = int(os.getenv("CANDIDATES_PER_AREA", 120))
ENRICH_LIMIT = int(os.getenv("ENRICH_LIMIT", 400))
VERIFY_LIMIT = int(os.getenv("VERIFY_LIMIT", 240))
MAX_PAPERS_PER_PI = 3
TARGET_TOTAL = int(os.getenv("TARGET_TOTAL", 70))
SIM_THRESHOLD = 0.60
